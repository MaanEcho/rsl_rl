...
from rsl_rl.modules import ActorCritic, ActorCriticCNN, ActorCriticRecurrent, ActorCriticDreamWaQV2
from rsl_rl.modules.rnd import RandomNetworkDistillation
from rsl_rl.storage import RolloutStorage, RolloutStorageDreamWaQV2
...
class PPODreamWaQV2:
    ...
    policy: ActorCritic | ActorCriticRecurrent | ActorCriticCNN | ActorCriticDreamWaQV2
    """The actor critic module."""

    def __init__(
        self,
        policy: ActorCritic | ActorCriticRecurrent | ActorCriticCNN | ActorCriticDreamWaQV2,
        storage: RolloutStorage | RolloutStorageDreamWaQV2,
        # CENet parameters
        cenet_cfg: dict,
        ...
        **kwargs: dict[str, Any],
        ...
        if kwargs:
            print(
                "PPODreamWaQV2.__init__ got unexpected arguments, which will be ignored: " + str([key for key in kwargs])
            )
