...
from rsl_rl.modules import ActorCritic, ActorCriticCNN, ActorCriticRecurrent, ActorCriticEstimatorV1
from rsl_rl.modules.rnd import RandomNetworkDistillation
from rsl_rl.storage import RolloutStorage, RolloutStorageEstimatorV1
from rsl_rl.utils import string_to_callable


class PPOEstimatorV1:
    """Proximal Policy Optimization algorithm (https://arxiv.org/abs/1707.06347)."""

    policy: ActorCritic | ActorCriticRecurrent | ActorCriticCNN | ActorCriticEstimatorV1
    """The actor critic module."""

    def __init__(
        self,
        policy: ActorCritic | ActorCriticRecurrent | ActorCriticCNN | ActorCriticEstimatorV1,
        storage: RolloutStorage | RolloutStorageEstimatorV1,
        # CENet parameters
        cenet_cfg: dict,
        ...
        **kwargs: dict[str, Any],
        ...
        if kwargs:
            print(
                "PPOEstimatorV1.__init__ got unexpected arguments, which will be ignored: " + str([key for key in kwargs])
            )
    ...
    def update(self, current_iteration: int, total_iterations: int) -> dict[str, float]:
        ...
        for (
            ...
            encode_lin_vel_batch, encode_feet_clearances_batch = self.policy.act(obs_batch, self.bootstrap, stage="update", masks=masks_batch, hidden_state=hidden_states_a_batch)
            ...
            cenet_loss = vel_est_loss + feet_clearances_est_loss
