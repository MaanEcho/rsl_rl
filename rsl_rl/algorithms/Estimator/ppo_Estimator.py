...
from rsl_rl.modules import ActorCritic, ActorCriticCNN, ActorCriticRecurrent, ActorCriticEstimator
from rsl_rl.modules.rnd import RandomNetworkDistillation
from rsl_rl.storage import RolloutStorage, RolloutStorageEstimator
...
class PPOEstimator:
    ...
    policy: ActorCritic | ActorCriticRecurrent | ActorCriticCNN | ActorCriticEstimator
    """The actor critic module."""

    def __init__(
        self,
        policy: ActorCritic | ActorCriticRecurrent | ActorCriticCNN | ActorCriticEstimator,
        storage: RolloutStorage | RolloutStorageEstimator,
        # CENet parameters
        cenet_cfg: dict,
        ...
        **kwargs: dict[str, Any],
        ...
        if kwargs:
            print(
                "PPOEstimator.__init__ got unexpected arguments, which will be ignored: " + str([key for key in kwargs])
            )
