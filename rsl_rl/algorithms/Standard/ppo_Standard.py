...
from rsl_rl.modules import ActorCritic, ActorCriticCNN, ActorCriticRecurrent, ActorCriticStandard
...
class PPOStandard:
    ...
    policy: ActorCritic | ActorCriticRecurrent | ActorCriticCNN | ActorCriticStandard
