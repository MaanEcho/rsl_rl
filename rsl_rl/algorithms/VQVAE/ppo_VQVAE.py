...
from rsl_rl.modules import ActorCritic, ActorCriticCNN, ActorCriticRecurrent, ActorCriticVQVAE
...
class PPOVQVAE:
    ...
    policy: ActorCritic | ActorCriticRecurrent | ActorCriticCNN | ActorCriticVQVAE
    ...
    def __init__(
        ...
        **kwargs: dict[str, Any],
        ...
        if kwargs:
            print(
                "PPOVQVAE.__init__ got unexpected arguments, which will be ignored: " + str([key for key in kwargs])
            )
        ...
        self.cenet_optimizer = optim.Adam(policy.cenet.parameters(), lr=self.cenet_lr_initial)
        # Sanity check
    ...
    def update(self, current_iteration: int, total_iterations: int) -> dict[str, float]:
        ...
        for (
            ...
            codebook_loss = nn.functional.mse_loss(z_e_batch[valid].detach(), z_q_batch[valid])
            ...
            nn.utils.clip_grad_norm_(self.policy.cenet.parameters(), self.cenet_max_grad_norm)
