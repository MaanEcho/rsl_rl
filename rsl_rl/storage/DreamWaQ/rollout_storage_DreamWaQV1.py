...
class RolloutStorageDreamWaQV1:
    ...
    class Transition:
        ...
        def __init__(self) -> None:
            ...
            self.reconstructed_obs_targets: torch.Tensor | None = None
    ...
    def __init__(
        ...
        if training_type == "rl":
            ...
            self.reconstructed_obs_targets = torch.zeros(num_transitions_per_env, num_envs, obs["proprioception"].shape[-1], device=self.device)
    ...
    def add_transition(self, transition: Transition) -> None:
        ...
        if self.training_type == "rl":
            ...
            self.reconstructed_obs_targets[self.step].copy_(transition.reconstructed_obs_targets)
    ...
    def mini_batch_generator(self, num_mini_batches: int, num_epochs: int = 8) -> Generator:
        ...
        reconstructed_obs_targets = self.reconstructed_obs_targets.flatten(0, 1)
