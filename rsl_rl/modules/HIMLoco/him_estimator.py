...
import torch.distributions as torchd  # noqa: F401
from torch.distributions import Normal, Categorical  # noqa: F401
...
class HIMEstimator(nn.Module):
    def __init__(self,
        ...
        enc_layers = []
        for l in range(len(enc_hidden_dims) - 1):  # noqa: E741
        ...
        tar_layers = []
        for l in range(len(tar_hidden_dims)):  # noqa: E741
