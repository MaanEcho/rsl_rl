...
class ActorCriticDreamWaQV2(nn.Module):
    ...
    def __init__(
        ...
        **kwargs: dict[str, Any],
        ...
        if kwargs:
            print(
                "ActorCriticDreamWaQV2.__init__ got unexpected arguments, which will be ignored: " + str([key for key in kwargs])
            )
        super().__init__()
...
class InferenceWrapper(nn.Module):
    def __init__(self, models: ActorCriticDreamWaQV2) -> None:
        super().__init__()
